...
static PyCodeObject *codeobj_a12b79f0ae3b6c72eada4311390e837d;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[19]); CHECK_OBJECT(module_filename_obj);
    codeobj_a12b79f0ae3b6c72eada4311390e837d = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[20], mod_consts[20], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_a12b79f0ae3b6c72eada4311390e837d;
    ...
    frame_a12b79f0ae3b6c72eada4311390e837d = MAKE_MODULE_FRAME(codeobj_a12b79f0ae3b6c72eada4311390e837d, module_numpy$typing$_nbit);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_a12b79f0ae3b6c72eada4311390e837d);
    assert(Py_REFCNT(frame_a12b79f0ae3b6c72eada4311390e837d) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a12b79f0ae3b6c72eada4311390e837d, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a12b79f0ae3b6c72eada4311390e837d->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a12b79f0ae3b6c72eada4311390e837d, exception_lineno);
    }



    assertFrameObject(frame_a12b79f0ae3b6c72eada4311390e837d);
